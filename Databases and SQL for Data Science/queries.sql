...
-- Query 5B: For each department retrieve the number of employees in the department, and the average employees
...
-- Query 6: Similar to 4B but instead of department ID use MANAGER_ID. Retrieve a list of employees ordered
-- by department name, and within each department ordered alphabetically in descending order by last name
